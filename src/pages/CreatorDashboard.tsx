...
export function CreatorDashboard() {
  ...
  // Removed theme context usage: currentTheme, setTheme, isLoadingTheme, themeError
  ...
  // const [selectedDisplayTheme, setSelectedDisplayTheme] = useState<ThemeName>(currentTheme); // Removed

  // React.useEffect(() => { // Removed effect for selectedDisplayTheme
